...
def display(p):
	...
	close_btn.grid(row=8, column=1, padx=10, pady=30)

	close_btn=tk.Button(master=leftFrame, text="Konec", command=p.top.destroy, width=10)
	close_btn.grid(row=8, column=2, padx=10, pady=30)
	...
	p.canvas.grid()
	p.wid.grid(row=1, column=1, rowspan=6000, padx=50, pady=10)
